...
3. Add a runtime config that uses gremlin (see [example](https://github.com/gremlin/gremlin-boshrelease/tree/master/examples) to get started): `bosh update-runtime-config gremlin-runtime-config.yml`
